...
Scene::Scene() {
    ...
    triangleList[1] = Triangle(Vertex(5, 0, -5, 1),
                               Vertex(13, 0, -5, 1),
                               Vertex(10, 6, -5, 1),
                               ColorDbl(1, 1, 1));

    triangleList[2] = Triangle(Vertex(5, 0, -5, 1),
                               Vertex(10, -6, -5, 1),
                               Vertex(13, 0, -5, 1),
                               ColorDbl(1, 1, 1));

    triangleList[3] = Triangle(Vertex(5, 0, -5, 1),
                               Vertex(0, -6, -5, 1),
                               Vertex(10, -6, -5, 1),
                               ColorDbl(1, 1, 1));

    triangleList[4] = Triangle(Vertex(5, 0, -5, 1),
                               Vertex(-3, 0, -5, 1),
                               Vertex(0, -6, -5, 1),
                               ColorDbl(1, 1, 1));

    triangleList[5] = Triangle(Vertex(5, 0, -5, 1),
                               Vertex(0, 6, -5, 1),
                               Vertex(-3, 0, -5, 1),
                               ColorDbl(1, 1, 1));
    ...
    triangleList[7] = Triangle(Vertex(5, 0, 5, 1),
                               Vertex(10, 6, 5, 1),
                               Vertex(13, 0, 5, 1),

                               ColorDbl(1, 1, 1));

    triangleList[8] = Triangle(Vertex(5, 0, 5, 1),
                               Vertex(13, 0, 5, 1),
                               Vertex(10, -6, 5, 1),

                               ColorDbl(1, 1, 1));

    triangleList[9] = Triangle(Vertex(5, 0, 5, 1),
                               Vertex(10, -6, 5, 1),
                               Vertex(0, -6, 5, 1),

                               ColorDbl(1, 1, 1));

    triangleList[10] = Triangle(Vertex(5, 0, 5, 1),
                                Vertex(0, -6, 5, 1),
                               Vertex(-3, 0, 5, 1),

                               ColorDbl(1, 1, 1));

    triangleList[11] = Triangle(Vertex(5, 0, 5, 1),
                                Vertex(-3, 0, 5, 1),
                               Vertex(0, 6, 5, 1),
    ...
    triangleList[13] = Triangle(Vertex(10, -6, -5, 1),
                                Vertex(0, -6, 5, 1),
                                Vertex(10, -6, 5, 1),
                                ColorDbl(0, 0, 1));

    //__________________NORTH____________________
    triangleList[14] = Triangle(Vertex(10, 6, -5, 1),
                                Vertex(10, 6, 5, 1),
                                Vertex(0, 6, -5, 1),
                                ColorDbl(0, 1, 0));

    triangleList[15] = Triangle(Vertex(0, 6, -5, 1),
                                Vertex(10, 6, 5, 1),
                                Vertex(0, 6, 5, 1),
                                ColorDbl(0, 1, 0));

    //__________________NORTH-EAST___________________
    triangleList[16] = Triangle(Vertex(13, 0, -5, 1),
                                Vertex(13, 0, 5, 1),
                                Vertex(10, 6, -5, 1),
                                ColorDbl(1, 0, 0));

    triangleList[17] = Triangle(Vertex(10, 6, -5, 1),
                                Vertex(13, 0, 5, 1),
                                Vertex(10, 6, 5, 1),
                                ColorDbl(1, 0, 0));
