...
Tetrahedron::Tetrahedron(Vertex _v0) {
    ...
    triangles[0] = Triangle(v0, v1, v2,ColorDbl(0.5, 0, 1), LAMBERTIAN);
    triangles[1] = Triangle(v0, v3, v1,ColorDbl(0.5, 0.5, 0), LAMBERTIAN);
    triangles[2] = Triangle(v0, v2, v3,ColorDbl(0, 0.5, 1), LAMBERTIAN);
    triangles[3] = Triangle(v1, v3, v2,ColorDbl(0.3, 0, 0.7), LAMBERTIAN);
}
