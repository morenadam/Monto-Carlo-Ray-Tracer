...
Tetrahedron::Tetrahedron(Vertex _v0) {
    ...
    triangles[0] = Triangle(v0, v1, v2, ColorDbl(0.7, 0.4, 0.7), LAMBERTIAN);
    triangles[1] = Triangle(v0, v3, v1, ColorDbl(0.7, 0.4, 0.7), LAMBERTIAN);
    triangles[2] = Triangle(v0, v2, v3, ColorDbl(0.7, 0.4, 0.7), LAMBERTIAN);
    triangles[3] = Triangle(v1, v3, v2, ColorDbl(0.7, 0.4, 0.7), LAMBERTIAN);
}
